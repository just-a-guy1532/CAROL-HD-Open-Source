...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else
		{
			...
			portraitGF = new Portrait(170, 70, "gf");
			add(portraitGF);

			portraitCAROL = new Portrait(62, 0, "carol");
			add(portraitCAROL);
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			...
			case "carol":
				portraitCAROL.playFrame(curAnim);
				changeSound('carolText',0.6);
			case "spooky":
	...
	var portraitArray = [portraitBF,portraitGF,portraitCAROL,portraitSPOOKY,portraitMONSTER,portraitDARNELL,portraitNENE,portraitMOM,portraitPICO,portraitIMPS,portraitSONIC,portraitSUPERSONIC];
