...
class Portrait extends FlxSprite
{
    ...
    public var characters:Array<String> = ["bf", "gf", "carol", "spooky", "monster", "pico", "darnell", "nene", 'mom', 'imps', 'sonic', 'super-sonic', 'sonic'];
    ...
    function defineCharacter(_character){
        ...
        switch(_character){
            ...
            case "gf":
                ...
                resize = 0.50;
            case "carol":
                addAnim("default", "carol idle");
                addAnim("ayo", "carol ayo");
                addAnim("angry", "carol angry");
                addAnim("bye", "carol bye");
                addAnim("down", "carol down");
                addAnim("funny", "carol funny");
                addAnim("happy", "carol happy");
                addAnim("what", "carol a");
                addAnim("front", "carol idlefront");
                addAnim("letsbatlle", "carol letsbattle");
                addAnim("phone", "carol phone");
                addAnim("question", "carol question");
                addAnim("stressed", "carol stressed");
                addAnim("surprised", "carol surprised");
                addAnim("worried", "carol worried");
                addAnim("youaredead", "carol youaredead");
                animation.play("default");
                resize = 0.5;
            case "spooky":
